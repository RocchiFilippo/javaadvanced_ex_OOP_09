...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        Rectangle rettangolo = new Rectangle(12, 10);

        System.out.println("area cerchio = " + cerchio.calculateArea());
        System.out.println("area rettangolo = " + rettangolo.calculateArea());
    }
    ...
    private static void exercise2() {
        ...
        System.out.println(macchina.moveForward());
        System.out.println(macchina.moveBackward());
        System.out.println(barca.moveBackward());
        System.out.println(barca.moveForward());
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        // Your code here
        Guitar chitarra = new Guitar("chitarra", "Balto");
        Piano piano = new Piano("Piano", "Pianelli");
